        ...
        <div class="mt-8">
            <flux:tab.group>
                <flux:tabs class="px-4">
                    ...
                    @if($modelFamily->models && $modelFamily->models->count() > 0)
                        ...
                        <flux:container>
                            <div class="prose max-w-none">
                                <div class="mb-8">
                                    ...
                                    <p>{{ $modelFamily->description }}</p>
                                </div>

                                <div class="mb-8">
                                    <h2 class="text-lg font-semibold mb-2">Created</h2>
                                    <p>{{ $modelFamily->created_at->format('F j, Y') }}</p>
                                </div>

                                <div class="mb-8">
                                    <h2 class="text-lg font-semibold mb-2">Last Updated</h2>
                                    <p>{{ $modelFamily->updated_at->format('F j, Y') }}</p>
                                </div>
                            </div>
                        </flux:container>
                    </flux:tab.panel>
                    ...
                    @if($modelFamily->models && $modelFamily->models->count() > 0)
                        <flux:tab.panel name="models">
                            <flux:container>
                                <ul class="divide-y">
                                    @foreach($modelFamily->models as $model)
                                        <li class="py-4">
